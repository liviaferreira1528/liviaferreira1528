...
🎨 **UX/UI Designer em formação**
💡 Transformando ideias em experiências digitais intuitivas

---

## 🚀 Sobre mim

Sou estudante de **Informática no ensino médio técnico** e estou focada em construir minha carreira como **UX/UI Designer**.

Tenho interesse em criar interfaces:
...
Interface web temática focada em organização e experiência do usuário

### 💄 Maré Mansa

Layout de e-commerce com foco em usabilidade e design atrativo

### 📚 Study Mate

Protótipo de aplicativo para organização de estudos
...
* Iniciação de Projetos — Google
* Prototipação no Figma
* Fundamentos de Redes — Huawei
...
">
  ...
  <a href="https://www.linkedin.com/in/lívia-ferreira-design">
